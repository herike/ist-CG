...
function createShip(xi, yi, zi) {
    ...
    poligon_createWingSpike(ship_aux, -15, -5, -5,false,-3, s_material_orange);
    poligon_createWingSpike(ship_aux, 15, -5, -5,false,-2, s_material_orange,0,1);
